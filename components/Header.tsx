      ...
      <div className="flex h-20 items-center justify-between md:justify-end gap-4 px-4 sm:px-8">
        ...
        <div className="flex-1 md:max-w-xl md:mx-auto lg:mr-auto lg:ml-8">
          <div className="relative group">
            <div className="absolute inset-0 bg-blue-500/5 rounded-2xl blur-md transition-all group-hover:bg-blue-500/10"></div>
            <div className="relative flex items-center gap-3 bg-white border border-slate-200 px-4 py-3 rounded-2xl cursor-text transition-all hover:border-blue-400 hover:shadow-[0_4px_20px_rgba(59,130,246,0.1)] shadow-sm">
              <SearchCommand
                ...
                label={
                  <div className="flex items-center gap-3 text-base text-slate-400 font-medium w-full">
                    ...
                    <kbd className="hidden sm:inline-flex items-center gap-1 rounded-md border border-slate-200 bg-slate-50 px-2 py-0.5 font-mono text-[11px] font-bold text-slate-500">
                      <span>⌘</span>K
                    </kbd>
                  </div>
                }
